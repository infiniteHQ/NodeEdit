...
namespace NodeEdit {
  ...
  NODEEDIT_API void AddSchemaToContext(const std::string &ctx_id, const NodeEditSchema &schema);
  NODEEDIT_API void AddPinFormatToContext(const std::string &ctx_id, const NodeEditPinFormat &pin_format);
  ...
  NODEEDIT_API void SaveGraphSession(const std::shared_ptr<NodeEdit::NodeEditGraphSession> &graph);
  NODEEDIT_API void RefreshGraphSession(const std::shared_ptr<NodeEdit::NodeEditGraphSession> &graph);

  NODEEDIT_API void GetConnected(
  ...
  NODEEDIT_API std::string SearchNodeInputPinByType(
      ...
      const std::string &nodeid,
      const std::string &type);  // id (from NodeEditPin)
  NODEEDIT_API std::string SearchNodeType(
      const std::shared_ptr<NodeEdit::NodeEditGraphSession> &graph,
      const std::string &type);  // return instance_id

  // helpers
  NODEEDIT_API const NodeEdit::NodeEditInstance *FindInstance(
      const NodeEdit::NodeEditGraph &graph,
      const std::string &instance_id);

  NODEEDIT_API const NodeEdit::NodeEditSchema *FindSchema(const NodeEdit::NodeEditContext &ctx, const std::string &type_id);

  NODEEDIT_API const NodeEdit::NodeEditContext *FindContext(const std::string &context_id);

  NODEEDIT_API std::vector<std::pair<std::string, std::string>> GetAllNodeInputPins(
      const std::shared_ptr<NodeEdit::NodeEditGraphSession> &graph,
      const std::string &nodeid);

  NODEEDIT_API std::vector<std::pair<std::string, std::string>> GetAllNodeOutputPins(
      const std::shared_ptr<NodeEdit::NodeEditGraphSession> &graph,
      const std::string &nodeid);
  ...
  // Effect API
  NODEEDIT_API void AddEffectToNode(
      const std::shared_ptr<NodeEdit::NodeEditGraphSession> &graph,
  ...
  NODEEDIT_API void SetGraphTitle(const std::shared_ptr<NodeEdit::NodeEditGraphSession> &graph, const std::string &title);
